...
<div class="container mt-5">
    <div class="card">
        <div class="card-body">
            ...
            <form id="form"  action="/admin/updateAreaData/${area.areaId}" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="areaName" id="cityNameInput" value="${area.areaName}">
                    </div>
                    <div class="mb-3">
                        <label for="cityDescriptionInput" class="form-label">Area Description</label>
                        <input type="text" class="form-control"  name="areaDescription" id="cityDescriptionInput" value="${area.areaDescription}">
                    </div>
