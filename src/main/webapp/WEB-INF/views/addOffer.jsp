...
<div class="container mt-5">
    <div class="card">
        <div class="card-body">
            ...
            <form id="form"  action="/restaurant/saveOfferData" method="POST">
            <div class="mb-3 row">
                <div class="col">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="offerNameInput" name="offerName" required>
            </div>
            <div class="mb-3">
                <label for="offerDescriptionInput" class="form-label">Offer Description</label>
                <input type="text" class="form-control" id="offerDescriptionInput" name="offerDescription" required>
            </div>
            <div class="mb-3 row">
                <div class="col">
                    <label for="startDateInput" class="form-label">Start Date</label>
                    <input type="datetime-local" class="form-control" id="startDateInput" name="startDate" required>
                </div>
                <div class="col">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="discountInput" name="offerDiscount" maxlength="3" min="0" max="100" required>
            </div>
