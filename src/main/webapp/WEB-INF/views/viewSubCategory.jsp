    ...
    <tbody>
      <c:forEach var="subCategory" items="${subCategories}">
          <tr>
              ...
              <td>
                <a class="btn btn-sm btn-outline-primary" id="editBtn" href="/admin/editSubCategoryData/${subCategory.subCategoryId}">
                  <i class="bi bi-pencil-fill"></i>
                </a>
              <a class="btn btn-sm btn-outline-danger" href="/admin/deleteSubCategory/${subCategory.subCategoryId}">
